...
export const useStoreLayoutItem = defineStore("layout-item", {
  state: () => ({
      page: "" as String,
      navigations: [] as Array<Object>,
  }),

  actions:{
    setNavigations(listNavigations: Object[]){
        this.navigations = listNavigations
    }
  }
});
